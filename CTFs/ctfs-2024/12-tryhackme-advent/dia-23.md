...
```
 user@ip-10-10-94-149:~/AOC2024$ john --format=raw-sha256 -w=/usr/share/wordlists/rockyou.txt 
hash1.txt --rules=wordlist
Using default input encoding: UTF-8
Loaded 1 password hash (Raw-SHA256 [SHA256 256/256 AVX2 8x])
Warning: poor OpenMP scalability for this hash type, consider --fork=2
Will run 2 OpenMP threads
...
fluffycat12      (?)     
1g 0:00:00:16 DONE (2024-12-23 16:23) 0.06053g/s 2348Kp/s 2348Kc/s 2348KC/s markie182..cherry
lee2
Use the "--show --format=Raw-SHA256" options to display all of the cracked passwords reliably
Session completed. 
user@ip-10-10-94-149:~/AOC2024$ 
...
```
user@ip-10-10-186-170:~/AOC2024$ cat wl.txt 
Fluffy
FluffyCat
Mayor
Malware
MayorMalware
user@ip-10-10-186-170:~/AOC2024$ john hashpdf -w=wl.txt --rules=single
Using default input encoding: UTF-8
...
1g 0:00:00:00 DONE (2024-12-23 21:52) 4.167g/s 5066p/s 5066c/s 5066C/s mayored..afluffy
Use the "--show --format=PDF" options to display all of the cracked passwords reliably
Session completed. 
user@ip-10-10-186-170:~/AOC2024$ 

pdftotext -upw M4y0rM41w4r3 private.pdf 
user@ip-10-10-186-170:~/AOC2024$ ls
example_files  hash1.txt  private.pdf  wl.txt
hash-id.py     hashpdf    private.txt  wordlist.txt
user@ip-10-10-186-170:~/AOC2024$ head private.txt 
transactions
