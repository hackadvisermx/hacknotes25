...
```
- tomo la parte del codigo en la funcion checkPassword y lo gurado en un archivo.

-  le agrego 0s a las cantidades para hacerlas de 2 digitos y poderlas cutear
