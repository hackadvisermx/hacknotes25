...
Antes de iniciar cambiar el idioma a ingles para que los nombres de las ciudad coincidan,
esto se hace en el menu de lado izquierdo en la misma barra de busqueda google maps
