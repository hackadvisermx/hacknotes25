...
```
masscan -e tun0 10.10.31.190 -p 1-65535 --rate 5000

sudo nmap -sS -n -Pn --min-rate=5000 -p- -v 10.10.31.190s

[sudo nmap -sS -n -Pn --min-rate=5000 -p- -v 10.10.31.190
Starting Nmap 7.94SVN ( https://nmap.org ) at 2024-09-25 23:08 CDT
Initiating SYN Stealth Scan at 23:08
Scanning 10.10.31.190 [65535 ports]
Discovered open port 21/tcp on 10.10.31.190
Discovered open port 22/tcp on 10.10.31.190
Discovered open port 31331/tcp on 10.10.31.190
Increasing send delay for 10.10.31.190 from 0 to 5 due to 1005 out of 3348 dropped probes since last increase.
Discovered open port 8081/tcp on 10.10.31.190
Completed SYN Stealth Scan at 23:08, 14.91s elapsed (65535 total ports)
Nmap scan report for 10.10.31.190
...
Nmap done: 1 IP address (1 host up) scanned in 14.98 seconds
           Raw packets sent: 71646 (3.152MB) | Rcvd: 70325 (2.813MB)](<sudo nmap -sV  -n -Pn --min-rate=5000 -p- -v 10.10.31.190  
Starting Nmap 7.94SVN ( https://nmap.org ) at 2024-09-25 23:16 CDT
...
Discovered open port 8081/tcp on 10.10.31.190
Discovered open port 31331/tcp on 10.10.31.190
Completed SYN Stealth Scan at 23:16, 14.64s elapsed (65535 total ports)
Initiating Service scan at 23:16
Scanning 4 services on 10.10.31.190
Completed Service scan at 23:16, 11.56s elapsed (4 services on 1 host)
NSE: Script scanning 10.10.31.190.
Initiating NSE at 23:16
Completed NSE at 23:17, 0.77s elapsed
Initiating NSE at 23:17
Completed NSE at 23:17, 0.70s elapsed
Nmap scan report for 10.10.31.190
Host is up (0.18s latency).
Not shown: 65531 closed tcp ports (reset)
...
Nmap done: 1 IP address (1 host up) scanned in 27.87 seconds
           Raw packets sent: 70900 (3.120MB) | Rcvd: 70472 (2.819MB)>)
```
...
- hago una busquededa en partners y encontramos el end point del ping
```
